...
public class FragmentNovedades extends Fragment {
    ...
    TextView Titulo, Info, Punto1,Punto2,Punto3,Punto4,Punto5;
    ImageView Imagen;
    Button BtnNovedades;
    ...
    private void ObtenerDatos() {
        mFirestore.collection("Novedades").document("Promocion").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
