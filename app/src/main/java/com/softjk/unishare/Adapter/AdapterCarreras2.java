...
public class AdapterCarreras2 extends FirestoreRecyclerAdapter<Carreras, AdapterCarreras2.ViewHolder> {
    Activity activity;
    SharedPreferences preferences;
    public AdapterCarreras2(@NonNull FirestoreRecyclerOptions<Carreras> options, Activity activity) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdapterCarreras2.ViewHolder viewHolder, int i, @NonNull Carreras carreras) {
    ...
    @NonNull
    @Override
    public AdapterCarreras2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
