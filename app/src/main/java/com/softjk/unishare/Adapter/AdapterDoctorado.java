...
public class AdapterDoctorado extends FirestoreRecyclerAdapter<Carreras, AdapterDoctorado.ViewHolder> {
    Activity activity;
    public AdapterDoctorado(@NonNull FirestoreRecyclerOptions<Carreras> options, Activity activity) {
        super(options);
        this.activity = activity;
    }

    @Override
    protected void onBindViewHolder(@NonNull AdapterDoctorado.ViewHolder viewHolder, int i, @NonNull Carreras carreras) {
    ...
    @NonNull
    @Override
    public AdapterDoctorado.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
