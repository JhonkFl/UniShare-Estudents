...
public class Carreras {
    String Logo, Info, Campo1,Nombre,Campo2,Campo3,Campo4,Campo5,Campo6,Campo7,Campo8,Campo9,Campo10,Campo11,ABC,Categoria;
    public Carreras() {
    }

    public Carreras(String logo, String info, String campo1, String nombre, String campo2, String campo3, String campo4,
                    String campo5, String campo6, String campo7, String campo8, String campo9, String campo10, String campo11,
                    String abc, String categoria) {
        Logo = logo;
        Info = info;
        Campo1 = campo1;
        Nombre = nombre;
