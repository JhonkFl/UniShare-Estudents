...
public class NotifiClien extends FirebaseMessagingService {
    ...
    private void mayorqueoreo(String Titulo, String Detalle) {
        ...
        NotificationChannel nc = new NotificationChannel(id, "Estudiantes", NotificationManager.IMPORTANCE_HIGH);
